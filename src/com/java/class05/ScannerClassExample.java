...
public class ScannerClassExample {
    ...
    // The pre-defined Classes (just like ScannerClassExample Class) are organized in the form of Packages
    // Package is the collection of Classes
    // Before we can use the class, we need to either import the entire package or the class (import java.util.ScannerClassExample)
    ...
    // ScannerClassExample s = new ScannerClassExample (System.in)
    // here "ScannerClassExample" on the right is the constructor to which we are passing an argument in a form of input stream object
    // and again, our argument consists of the ".in" - reference variable to the ScannerClassExample Class
    ...
    ScannerClassExample Class methods are the following:
    nextByte()
    nextShort()
    nextInt()
    nextLong()
